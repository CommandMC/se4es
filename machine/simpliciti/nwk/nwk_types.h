...
typedef struct ioctlRawSend_t ioctlRawSend_t;
struct ioctlRawSend_t
{
  addr_t   *addr;
  uint8_t  *msg;
  uint8_t   len;
...
typedef struct ioctlRawReceive_t ioctlRawReceive_t;
struct ioctlRawReceive_t
{
  addr_t  *addr;
  uint8_t *msg;
  uint8_t  len;
...
typedef struct rxMetrics_t rxMetrics_t;
struct rxMetrics_t
{
  rssi_t  rssi;
  uint8_t lqi;
...
typedef struct ioctlRadioSiginfo_t ioctlRadioSiginfo_t;
struct ioctlRadioSiginfo_t
{
...
typedef struct ioctlToken_t ioctlToken_t;
struct ioctlToken_t
{
 ...
 */
typedef struct freqEntry_t freqEntry_t;
struct freqEntry_t
{
  uint8_t logicalChan;
};

typedef struct ioctlScanChan_t ioctlScanChan_t;
struct ioctlScanChan_t
{
  uint8_t      numChan;
  freqEntry_t *freq;
};
 ...
 *
 *************************************************************************************/
typedef struct ioctlNVObj_t ioctlNVObj_t;
struct ioctlNVObj_t
{
  uint8_t    objVersion;
  uint16_t   objLen;
...
typedef struct rcvContext_t rcvContext_t;
struct rcvContext_t
{
  rcvType_t   type;
  union
...
typedef struct smplVersionInfo_t smplVersionInfo_t;
struct smplVersionInfo_t
{
...
typedef struct sfClientInfo_t sfClientInfo_t;
struct sfClientInfo_t
{
  addr_t    clientAddr;
  appPTid_t lastTID;
};

typedef struct sfInfo_t sfInfo_t;
struct sfInfo_t
{
